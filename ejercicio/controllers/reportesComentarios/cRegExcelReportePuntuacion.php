...
if(isset($_POST['pi'])){
  if(!empty($_POST['pi'])){
    ...
    if(!empty($_POST['pf'])){
      ...
      $reporte = $consulta->reporteComentariosPuntuacion($pi,$pf);
      ...
      if(is_null($reporte)){
        ...
        $_SESSION['mensaje']="No hay comentarios entre estas puntuaciones";
...
->setTitle('Reporte comentarios por puntuación')
->setSubject('Reporte')
...
$hoja->setCellValue("A1", "Reporte comentarios por puntuación");

$hoja->setCellValue("A3", "Puntuación inicial:");
$hoja->setCellValue("B3", $pi);
$hoja->setCellValue("D3", "Puntuación final:");
$hoja->setCellValue("E3", $pf);
...
$fileName="ReporteComentariosPuntuacion" . $fecha . ".xlsx";
# Crear un "escritor"
