...
if(isset($_POST['genero'])){
  if(!empty($_POST['genero'])){
    if(is_numeric($_POST['genero'])){
      ...
      $reporte = $consulta->reportegeneroComentarios($genero);
        if(is_null($reporte)){
          $generos = array(
            1  => "masculino",
            2  => "femenino",
          ...
          $_SESSION['mensaje']="No hay comentarios con el genero " . $generos[$genero];
...
->setTitle('Reporte comentarios por generos')
->setSubject('Reporte')
...
$hoja->setCellValue("A1", "Reporte Aprendices por genero");

$hoja->setCellValue("A3", "Genero:");
$hoja->setCellValue("D3", $reporte[0]['nombregen']);
...
$fileName="ReporteComentariosGenero". $reporte[0]['nombregen']. $fecha. ".xlsx";
# Crear un "escritor"
