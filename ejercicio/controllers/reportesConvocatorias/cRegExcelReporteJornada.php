...
if(isset($_POST['jornada'])){
  if(!empty($_POST['jornada'])){
    if(is_numeric($_POST['jornada'])){
       
      $jornada = (isset($_POST['jornada']) ? $_POST['jornada']:NULL);
  
      $reporte = $consulta->reporteJornadaConvocatorias($jornada);
      ...
      if(is_null($reporte)){
        ...
        $_SESSION['mensaje']="No hay convocatorias en esta jornada";
    ...
    $_SESSION['tipo_alert']="danger";
    $_SESSION['mensaje']="Seleccione una jornada";
    echo "<script>location.href='../../views/reportesConvocatorias.php'</script>";
  }
}
...
->setTitle('Reporte convocatorias por jornada')
->setSubject('Reporte')
...
$hoja->setCellValue("A1", "Reporte convocatorias por jornada");

$hoja->setCellValue("A3", "Jornada:");
$hoja->setCellValue("C3", $reporte[0]['nombrejor']);
...
$fileName="ReporteJornadaConvocatorias" . $fecha . ".xlsx";
# Crear un "escritor"
