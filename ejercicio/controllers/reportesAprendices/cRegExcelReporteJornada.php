...
if(isset($_POST['jornada'])){
  if(!empty($_POST['jornada'])){
    if(is_numeric($_POST['jornada'])){
      ...
      $reporte = $consulta->reporteJornada($jornada);
    }else{
...
->setTitle('Reporte Aprendices inscritos por Jornada')
->setSubject('Reporte')
...
$hoja->setCellValue("A1", "Reporte Aprendices por jornada");
...
$fileName="ReporteJornada". $reporte[0]['nombrejor']. "-". $fecha. ".xlsx";
# Crear un "escritor"
