...
if(isset($_POST['departamento'])){
  if(!empty($_POST['departamento'])){
    if(!empty($_POST['Ciudad'])){
      ...
      $reporte = $consulta->reporteLugar($departamento,$Ciudad);
      ...
      if(is_null($reporte)){
        ...
        $_SESSION['mensaje']="No hay usuario con este lugar de residencia";
      ...
      $_SESSION['tipo_alert']="danger";
      $_SESSION['mensaje']="Seleccione una opción en ciudad";
      echo "<script>location.href='../../views/reportesAprendices.php'</script>";
    }
  }else{
    if (session_status() !== PHP_SESSION_ACTIVE) {
    ...
    $_SESSION['tipo_alert']="danger";
    $_SESSION['mensaje']="Seleccione una opción en departamento";
    echo "<script>location.href='../../views/reportesAprendices.php'</script>";
  }
...
$hoja->setCellValue("A1", "Reporte Aprendices inscritos por Lugar de residencia");

$hoja->setCellValue("A3", "Departamento:");
$hoja->setCellValue("B3", $reporte[0]['nombreDepartamento']);
$hoja->setCellValue("D3", "Ciudad:");
$hoja->setCellValue("E3", $reporte[0]['nombreCiudad']);
...
$fileName="ReporteLugarResidencia" . $fecha . ".xlsx";
# Crear un "escritor"
